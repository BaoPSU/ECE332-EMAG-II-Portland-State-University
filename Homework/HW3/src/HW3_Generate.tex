...
\begin{givens}
\textbf{Givens:}\\
$f_c = 9.5{\times}10^9$ Hz (carrier)\\
$a = 0.03$ m,\ $b = 0.02$ m\\
$u_{p0} = c/\sqrt{\varepsilon_r} = 3{\times}10^8$ m/s\\
$L = 100$ m
\end{givens}
\end{minipage}
...
{\centering\begin{tabular}{|c|p{0.27\linewidth}|p{0.27\linewidth}|p{0.23\linewidth}|}
\hline
\textbf{Mode} & \textbf{$f_c = f_{mn}$} & \textbf{$u_g = u_{p0}\sqrt{1-(f_{mn}/f)^2}$} & \textbf{$t = L/u_g$} \\
\hline
\rowcolor{purplebg!40}TE$_{10}$ &
$f_{10} = \tfrac{u_{p0}}{2a}$ \par $= \tfrac{3{\times}10^8}{2(0.03)}$ \par $= 5$ GHz $< 9.5$G \par \textbf{Excited} &
$= 3{\times}10^8\sqrt{1-\left(\tfrac{5G}{9.5G}\right)^{\!2}}$ \par $= 255.1{\times}10^6$ m/s &
$= \tfrac{100}{255.1{\times}10^6}$ \par $\boxed{= 0.392\;\mu\text{s}}$ \\
\hline
TE$_{01}$ &
$f_{01} = \tfrac{u_{p0}}{2b}$ \par $= \tfrac{3{\times}10^8}{2(0.02)}$ \par $= 7.5$ GHz $< 9.5$G \par \textbf{Excited} &
$= 3{\times}10^8\sqrt{1-\left(\tfrac{7.5G}{9.5G}\right)^{\!2}}$ \par $= 184.1{\times}10^6$ m/s &
$= \tfrac{100}{184.1{\times}10^6}$ \par $\boxed{= 543.1\;\text{ns}}$ \\
\hline
\rowcolor{purplebg!40}TE$_{20}$ &
$f_{20} = \tfrac{u_{p0}}{a}$ \par $= \tfrac{3{\times}10^8}{0.03}$ \par $= 10$ GHz $> 9.5$G \par \textbf{Not excited} &
N/A &
N/A \\
\hline
TE$_{11}$ \par TM$_{11}$ &
$f_{11} = \tfrac{u_{p0}}{2}\sqrt{\tfrac{1}{a^2}+\tfrac{1}{b^2}}$ \par $= \tfrac{3{\times}10^8}{2}\sqrt{\tfrac{1}{0.03^2}+\tfrac{1}{0.02^2}}$ \par $= 9.014$ GHz $< 9.5$G \par \textbf{Excited} &
$= u_{p0}\sqrt{1-\left(\tfrac{9.014}{9.5}\right)^{\!2}}$ \par $= 95.10{\times}10^6$ m/s &
$= \tfrac{100}{95.10{\times}10^6}$ \par $\boxed{= 1.05\;\mu\text{s}}$ \\
\hline
\end{tabular}\par}
\renewcommand{\arraystretch}{1.0}

\vspace{4pt}
\textit{Higher modes arrive later: as $f_{mn} \to f$, $u_g \to 0$, so closer-to-cutoff modes have longer travel time. Group delay spread = max $t$ - min $t$ $\approx 1.05 - 0.392 \approx 0.66\;\mu$s across all excited modes.}
