...
\begin{itemize}[leftmargin=*]
  \item 11~GHz: $\lambda_g/2 = 16.36$~mm, $n=5$, expected $d=81.80$~mm, measured $=83.5$~mm, \% diff $=2.1\%$
  \item 9.5~GHz: $\lambda_g/2 = 21.56$~mm, $n\approx4.43$, nearest int $n=4$, expected $d=86.24$~mm, measured $=95.6$~mm, \% diff $=10.9\%$
  \item 8.5~GHz: $\lambda_g/2 = 27.84$~mm, $n=3$, expected $d=83.52$~mm, measured $=85.4$~mm, \% diff $=2.3\%$
\end{itemize}
...
\begin{itemize}[leftmargin=*]
  \item 11~GHz: $n = 83.5 / 16.36 = 5.10 \Rightarrow n = 5$ half-wavelengths
  \item 9.5~GHz: $n = 95.6 / 21.56 = 4.43 \Rightarrow n \approx 4$ half-wavelengths (some measurement uncertainty)
  \item 8.5~GHz: $n = 85.4 / 27.84 = 3.07 \Rightarrow n = 3$ half-wavelengths
\end{itemize}
...
\begin{itemize}[leftmargin=*]
  \item TE$_{10}$ ($m=1$, $n=0$): $f_c = c/(2a) = 6.54$~GHz (lowest)
  \item TE$_{20}$ ($m=2$, $n=0$): $f_c = c/a = 13.09$~GHz
  \item TE$_{01}$ ($m=0$, $n=1$): $f_c = c/(2b) = 14.58$~GHz
  \item TE$_{11}$/TM$_{11}$: $f_c = (c/2)\sqrt{1/a^2 + 1/b^2} = 15.98$~GHz (4th, not in top 3)
\end{itemize}
