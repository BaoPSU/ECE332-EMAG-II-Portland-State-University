...
\fb{Insert polar (azimuth) plot from Excel showing the radiation pattern across $\pm 90^\circ$. Use the 7 data points above; assume symmetry across $0^\circ$. A blank polar template is available at \texttt{src/photos/polar\_template.gif} for sketching.}
