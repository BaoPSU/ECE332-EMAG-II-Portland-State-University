...
\toprule
\rowcolor{rowB}average power density & POWER R\&T (1,1)\\
angle of reflection & ANGLES (1,2)\\
\rowcolor{rowB}critical angle & ANGLES (1,2)\\
angle of refraction & ANGLES (1,2)\\
\rowcolor{rowB}angle of transmission & ANGLES (1,2)\\
tangent of Brewster angle & ANGLES (1,2)\\
\rowcolor{rowB}Brewster angle & ANGLES (1,2)\\
polarization for reflected/transmitted waves & ANGLES coral note (1,2)\\
\rowcolor{rowB}enclosing a waveguide on both sides w/ length & CAVITY RES.\ (1,3)\\
