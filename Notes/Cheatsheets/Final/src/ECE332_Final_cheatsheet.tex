...
\toprule
\rowcolor{rowB}Avg power density $S_\text{av}\!=\!|E_0|^2/(2\eta)$ & POWER R\&T (1,1)\\
Angle of reflection $\theta_r\!=\!\theta_i$ & ANGLES (1,2)\\
\rowcolor{rowB}Critical angle $\theta_c\!=\!\arcsin(n_2/n_1)$ & ANGLES (1,2)\\
Angle of refraction (Snell) & ANGLES (1,2)\\
\rowcolor{rowB}Angle of transmission $\theta_t$ (Snell) & ANGLES (1,2)\\
Tangent of Brewster $\tan\theta_B\!=\!n_2/n_1$ & ANGLES (1,2)\\
\rowcolor{rowB}Brewster angle $\theta_B\!=\!\arctan(n_2/n_1)$ & ANGLES (1,2)\\
Polarization for refl./trans.\ at $\theta_B$ & ANGLES coral note (1,2)\\
\rowcolor{rowB}Cavity (guide closed both ends, len.\ $d$) & CAVITY RES.\ (1,3)\\
Large aperture ($d\!\ge\!$ several $\lambda$) & APERTURE ANT.\ (2,3)\\
\rowcolor{rowB}Circular aperture & APERTURE ANT.\ HPBW tbl.\ (2,3)\\
\bottomrule
\end{tabular}}}\par}
\end{ebox}
