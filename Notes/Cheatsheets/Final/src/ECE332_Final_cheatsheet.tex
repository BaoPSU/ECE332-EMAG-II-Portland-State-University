...
%-- Column 1 -----------------------------------
\shead{graybg}{gray}{TOPIC LOOKUP --- READ FIRST}
\begin{ebox}
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{1.5pt}\fontsize{5.4}{6.2}\selectfont\begin{tabular}{@{}p{0.62\linewidth}p{0.32\linewidth}@{}}
\toprule
\rowcolor{rowB}average power density ($S_\text{av}$) & POWER R\&T (1,1)\\
angle of reflection ($\theta_r$) & ANGLES (1,2)\\
\rowcolor{rowB}critical angle ($\theta_c$) & ANGLES (1,2)\\
angle of refraction ($\theta_t$, Snell) & ANGLES (1,2)\\
\rowcolor{rowB}angle of transmission ($\theta_t$, Snell) & ANGLES (1,2)\\
tangent of Brewster angle ($\tan\theta_B$) & ANGLES (1,2)\\
\rowcolor{rowB}Brewster angle ($\theta_B$) & ANGLES (1,2)\\
polarization for reflected/transmitted waves (at $\theta_B$) & ANGLES coral note (1,2)\\
\rowcolor{rowB}enclosing a waveguide on both sides w/ length ($f_{mnp}$) & CAVITY RES.\ (1,3)\\
large aperture ($d\!\ge\!$ several $\lambda$) & APERTURE ANT.\ (2,3)\\
\rowcolor{rowB}circular aperture (diam.\ $d$) & APERTURE ANT.\ HPBW tbl.\ (2,3)\\
direction of max radiation ($\theta_{\max}$) & BEAM PARAMS (2,2)\\
\bottomrule
\end{tabular}}}\par}
\end{ebox}
...
\begin{ebox}
\eq{Avg power density of plane wave}{lossless; $|E_0|$ peak E-field amp.}
\[S_\text{av} = \tfrac{|E_0|^2}{2\eta}\;(\text{W/m}^2)\]
\textit{$\eta$ = intrinsic impedance of the medium ($\Omega$):\;\ $\eta\!=\!\sqrt{\mu/\varepsilon}\!=\!\eta_0\sqrt{\mu_r/\varepsilon_r}\xrightarrow{\mu_r=1}\eta_0/\sqrt{\varepsilon_r}$;\ \ $\eta_0\!=\!120\pi\!\approx\!377\,\Omega$ (free space).}\\[1pt]
...
%-- Column 2 -----------------------------------
\shead{tealbg}{teal}{ANGLES --- REFLECTION, TRANSMISSION, CRITICAL, BREWSTER}
\begin{ebox}
\eq{Reflection angle (Snell, reflection)}{always}\;$\theta_r = \theta_i$\;(from normal)\\[1pt]
\eq{Transmission/refraction (Snell, refraction)}{single boundary; angles from normal}
\[\sin\theta_t = \sin\theta_i\sqrt{\tfrac{\varepsilon_{r1}}{\varepsilon_{r2}}} = \sin\theta_i\,\tfrac{n_1}{n_2}\]

\eq{Multilayer chain (Snell, chained)}{stack of slabs $1\to2\to3\to4$}
\[\sin\theta_{i+1} = \sin\theta_i\sqrt{\tfrac{\varepsilon_{r,i}}{\varepsilon_{r,i+1}}}\]

\eq{Air--slabs--air shortcut}{outer media identical; collapse of Snell chain}
\[\theta_{\text{exit}} = \theta_{\text{incident}}\]

\eq{Critical angle $\theta_c$}{TIR when $n_1>n_2$; no transmitted wave}
\[\sin\theta_c = \tfrac{n_2}{n_1} = \sqrt{\tfrac{\varepsilon_{r2}}{\varepsilon_{r1}}}\;\Rightarrow\;\theta_c = \arcsin\!\left(\tfrac{n_2}{n_1}\right)\]

\eq{Brewster angle $\theta_B$ ($\parallel$-pol only)}{$\Gamma_\parallel\!=\!0$; nonmag}
\[\tan\theta_B = \tfrac{n_2}{n_1} = \sqrt{\tfrac{\varepsilon_{r2}}{\varepsilon_{r1}}}\;\Rightarrow\;\theta_B = \arctan\!\left(\tfrac{n_2}{n_1}\right)\]
\textit{\color{coral}At $\theta_B$: reflected wave is pure $\perp$-pol ($\parallel$ reflection = 0); transmitted has both.}\\
\textit{\color{coral}Snell only sets \emph{angles}. Reflection/transmission \emph{magnitudes} need Fresnel coefficients ($\parallel$ vs $\perp$).}
\end{ebox}
...
\vspace{1pt}
\shead{bluebg}{blue}{EX --- HW4 P7 (aperture scaling)}
\begin{ebox}
\textit{\color{blue}Circular aperture, $\beta\!=\!3^\circ$ at $f\!=\!20$ GHz.}\\[1pt]
\textbf{(a)} $D\!=\!\tfrac{4\pi}{\beta^2}\!=\!\tfrac{4\pi}{(\pi/60)^2}\!=\!\boxed{4584}\!\to\!\mathbf{36.6}$ dB\\
\textbf{(b)} $A_p{\times}2$, $f$ same: $D'\!=\!2D\!=\!9168\!\to\!\boxed{\mathbf{39.6}\,\text{dB}}$, $\beta'\!=\!\beta/\sqrt{2}\!=\!\boxed{\mathbf{2.12^\circ}}$\\
\textbf{(c)} $f{\times}2$, $A_p$ same: $D'\!=\!4D\!=\!18336\!\to\!\boxed{\mathbf{42.6}\,\text{dB}}$, $\beta'\!=\!\beta/2\!=\!\boxed{\mathbf{1.5^\circ}}$
\end{ebox}
...
\vspace{1pt}
\shead{coralbg}{coral}{CAVITY RESONATOR (guide closed both ends, length $d$)}
\begin{ebox}
\eq{Resonant frequencies}{$m,n,p$ = mode indices; standing wave in all 3 dims}
\[f_{mnp} = \tfrac{c}{2\sqrt{\varepsilon_r}}\sqrt{\!\left(\tfrac{m}{a}\right)^{\!2}\!+\!\left(\tfrac{n}{b}\right)^{\!2}\!+\!\left(\tfrac{p}{d}\right)^{\!2}}\;(\text{Hz})\]
\textit{TE$_{mnp}$: $p\!\ge\!1$, at least one of $m,n\!\ge\!1$. TM$_{mnp}$: $m,n\!\ge\!1$, $p\!\ge\!0$.}\\
\textit{Dominant TE$_{101}$ when $a\!\ge\!d\!>\!b$:\ $f_{101}\!=\!\tfrac{c}{2\sqrt{\varepsilon_r}}\sqrt{1/a^2\!+\!1/d^2}$.}
\end{ebox}
...
%-- Column 1 -----------------------------------
\shead{purplebg}{purple}{DIPOLE TYPE BY LENGTH\\$l$ = antenna rod length (m)}
\begin{ebox}
\[\boxed{\lambda\;(\text{wavelength}) = \tfrac{c}{f} = \tfrac{3\times 10^8}{f}\;(\text{m})}\]
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.14\linewidth}p{0.28\linewidth}p{0.52\linewidth}@{}}
\toprule
...
\eq{Avg power density}{$l/\lambda<1/50$; far field}
\[\boxed{S(R,\theta) = \tfrac{\eta_0\, k^2 I_0^2\, l^2}{32\pi^2 R^2}\sin^2\theta}\;\;(\text{W/m}^2)\]
\textit{Equivalent: $S\!=\!S_{\max}\sin^2\theta$ with $S_{\max}\!=\!\eta_0 k^2 I_0^2 l^2/(32\pi^2 R^2)$ at $\theta\!=\!\pi/2$.}
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.40\linewidth}|p{0.54\linewidth}@{}}
\toprule
\rowcolor{rowB}$l$: rod length (m) & $I_0$: peak current (A)\\
$R$: obs.\ distance (m) & $\theta$: angle from dipole axis (rad)\\
\rowcolor{rowB}$k\!=\!2\pi/\lambda$ (rad/m) & $\eta_0\!=\!120\pi\!\approx\!377\,\Omega$\\
\bottomrule
\end{tabular}}}\par}
...
\begin{ebox}
\eq{Avg power density}{any $l$; far field}
\[\boxed{S(R,\theta) = \tfrac{15 I_0^2}{\pi R^2}\!\left[\tfrac{\cos\!\left(\tfrac{\pi l}{\lambda}\cos\theta\right)-\cos\!\left(\tfrac{\pi l}{\lambda}\right)}{\sin\theta}\right]^{\!2}}\;(\text{W/m}^2)\]
\textit{\color{coral}At $\theta\!=\!0,\pi$: bracket is $0/0$. L'H\^opital $\Rightarrow$ $S\!=\!0$ (no axial radiation). TI-36X alt: evaluate bracket at $\theta\!=\!0.001$ rad $\to$ tiny $\to 0$.}\\[1pt]
...
\vspace{1pt}
\shead{pinkbg}{pink}{LINEAR ANTENNA ARRAY\\$N$ = \# of elements, $d$ = interelement spacing (m)}
\begin{ebox}
...
\[\beta \approx 0.886\,\tfrac{\lambda}{Nd}\;(\text{rad}) = 50.8^\circ\cdot\tfrac{\lambda}{Nd}\]
\eq{Electronic steering (scan to $\theta_0$)}{replace $\gamma$ with $\gamma'\!=\!kd(\cos\theta\!-\!\cos\theta_0)$}
\[\delta \!=\!\tfrac{2\pi d}{\lambda}\cos\theta_0\;(\tfrac{\text{rad}}{\text{elt}});\;\;\theta_0\!=\!\tfrac{\pi}{2}{:}\text{broadside},\,0{:}\text{end-fire}\]
\eq{Frequency scan}{feed-line incr.\ $\Delta\ell\!=\!n_0\lambda_0$}
\[\cos\theta_0 \!\approx\! \tfrac{n_0\lambda_0}{d}\,\tfrac{\Delta f}{f_0}\]
\textit{\color{coral}Grating lobes appear if $d\!>\!\lambda$. Avoid.}
\end{ebox}

\vspace{1pt}
\shead{bluebg}{blue}{EX --- HW4 P8 (5-elem array, $d\!=\!3\lambda/4$)}
\begin{ebox}
\textit{\color{blue}$N\!=\!5$, broadside, equal phase, uniform amp.}\\[1pt]
$kd\!=\!2\pi(3/4)\!=\!3\pi/2$;\ \ $\gamma\!=\!\tfrac{3\pi}{2}\cos\theta$;\ \ $F_a^{\max}\!=\!25$ at $\theta\!=\!\pi/2$\\[1pt]
$\boxed{F_a^{\text{norm}}\!=\!\tfrac{1}{25}\!\cdot\!\tfrac{\sin^2((15\pi/4)\cos\theta)}{\sin^2((3\pi/4)\cos\theta)}}$\\[1pt]
$\beta\!=\!0.886\,\tfrac{\lambda}{Nd}\!=\!0.886\!\cdot\!\tfrac{4}{15}\!=\!\boxed{\mathbf{0.236}\,\text{rad}\!=\!\mathbf{13.5^\circ}}$
\end{ebox}

\columnbreak

%-- Column 2 -----------------------------------
\shead{greenbg}{green}{BEAM PARAMETERS --- $\theta_{\max}$, $\beta$, $\Omega_p$, $D$}
\begin{ebox}
\eq{Normalize}{always start here}
\[F(\theta) = S(\theta)/S_{\max}\;(\text{unitless})\]

\eq{Direction of max radiation $\theta_{\max}$}{angle where $F$ peaks; check 3 ways}
\[\text{(1) Set }\tfrac{dF}{d\theta}\!=\!0;\;\;\text{(2) sample } F \text{ at endpoints + middle};\;\;\text{(3) inspect symmetry}\]
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.50\linewidth}p{0.44\linewidth}@{}}
\toprule
Pattern type & $\theta_{\max}$\\
\midrule
\rowcolor{rowB}Hertzian, half-wave, $\lambda/4$ dipole, $\sin^k\theta$ & $\pi/2$ (broadside)\\
Linear array (broadside, $\delta\!=\!0$) & $\pi/2$\\
\rowcolor{rowB}Linear array (end-fire, $\delta\!=\!kd$) & $0$ or $\pi$\\
Steered array (linear phase $\delta$) & $\arccos(\delta\lambda/2\pi d)$\\
\rowcolor{rowB}Aperture (rect., uniform illum.) & $0$ (boresight)\\
Arbitrary $F(\theta)$ & set $dF/d\theta\!=\!0$ or sample\\
\bottomrule
\end{tabular}}}\par}\\[1pt]
...
\bottomrule
\end{tabular}}}\par}
\textit{\color{coral}TI-36X: \texttt{[2nd][d/dx]} for $\int_\square^\square$, RAD mode, multiply by $2\pi$.}\\[1pt]
...
\eq{Gain (if asked)}{$\xi\!=\!$ radiation efficiency (unitless), $0<\xi\le1$}
\[G = \xi D\;(\text{unitless})\qquad G_{\text{dB}}\!=\!10\log_{10}G\;(\text{dB})\]
\textit{Lossless / ideal antenna $\Rightarrow$ $G\!=\!D$.}\\[1pt]
\textit{$\xi\!=\!\tfrac{R_{\text{rad}}}{R_{\text{rad}}+R_{\text{loss}}}\!=\!\tfrac{P_{\text{rad}}}{P_{\text{rad}}+P_{\text{loss}}}$;\;\;$R_{\text{rad}}\!=\!2P_{\text{rad}}/I_0^2$ ($\Omega$); $R_{\text{in}}\!=\!R_{\text{rad}}\!+\!R_{\text{loss}}$.}
\end{ebox}

\vspace{1pt}
\shead{amberbg}{amber}{COMMON DIPOLE PARAMETERS}
\begin{ebox}
\textit{\color{coral}Lossless ($\xi\!=\!1$): $G\!=\!D$.}\\[1pt]
...
\begin{ebox}
\textit{\color{coral}For each antenna's $G$: if given by NAME (``half-wave dipole'' etc.) $\to$ COMMON DIPOLE PARAMS ($G\!=\!D$, lossless). Else (dB/linear value given) $\to$ use as given (convert dB $\to$ linear).}\\[1pt]
...
\vspace{1pt}
\shead{tealbg}{teal}{APERTURE ANTENNAS (horn, dish; large aperture, $d\!\ge$ several $\lambda$)}
\begin{ebox}
...
\textit{\color{coral}Far-field req.: $R\!\geq\!2d^2/\lambda$ ($d\!=\!$ largest aperture dim.).}\\[1pt]
\eq{Pattern (rect., uniform illum.)}{peak at $\theta\!=\!0$ (broadside)}
\[F(\theta) = \mathrm{sinc}^2\!\left(\tfrac{\pi\ell_x\sin\theta}{\lambda}\right);\;\;S_0\!=\!\tfrac{E_0^2 A_p^2}{2\eta_0\lambda^2 R^2}\]
...
\bottomrule
\end{tabular}}}\par}
\eq{Scaling (any ratio)}{$D\!\propto\!A_p/\lambda^2$;\ $\beta\!\propto\!\lambda/\sqrt{A_p}$}
...
\textit{If a parameter is unchanged, its ratio $=\!1$. Examples: double area $\to$ $D\!\times\!2$, $\beta\!\times\!1/\sqrt{2}$; double freq $\to$ $D\!\times\!4$, $\beta\!\times\!1/2$.}
\end{ebox}
