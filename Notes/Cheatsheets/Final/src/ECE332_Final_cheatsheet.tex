...
\begin{ebox}
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{1.5pt}\begin{tabular}{@{}p{0.62\linewidth}p{0.32\linewidth}@{}}
\toprule
\rowcolor{rowB}$S_\text{av}$ plane wave & POWER R\&T (1,1)\\
$\theta_r,\theta_t,\theta_c,\theta_B,\tan\theta_B$, pol.\ at Brew.\ & ANGLES (1,2)\\
\rowcolor{rowB}Cavity $f_{mnp}$ (guide closed both ends) & CAVITY RES.\ (1,3)\\
Aperture: large, circular, rectangular & APERTURE ANT.\ (2,3)\\
\bottomrule
\end{tabular}}}\par}
\end{ebox}
