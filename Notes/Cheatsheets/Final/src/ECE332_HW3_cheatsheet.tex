...
{\fontsize{5.2}{6.0}\selectfont\[\alpha=\omega\sqrt{\tfrac{\mu\varepsilon'}{2}}\sqrt{X{-}1},\,\beta=\omega\sqrt{\tfrac{\mu\varepsilon'}{2}}\sqrt{X{+}1},\,\theta_\eta=\tfrac{1}{2}\arctan\tfrac{\sigma}{\omega\varepsilon'}\]}
\end{ebox}
