...
\[\begin{aligned}
\tilde{\mathbf{E}}^i &= a_0\hat{e}\,e^{\mp jk_1u}&&\text{\tiny (incident wave, Med 1)}\\
\tilde{\mathbf{E}}^r &= \Gamma\,a_0\hat{e}\,e^{\pm jk_1u}&&\text{\tiny (reflected wave, Med 1)}\\
\tilde{\mathbf{E}}^t &= \tau\,a_0\hat{e}\,e^{\mp jk_2u}&&\text{\tiny (transmitted wave, Med 2)}
\end{aligned}\]
...
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{1pt}\fontsize{5.2}{6.0}\selectfont\begin{tabular}{@{}p{0.23\linewidth}p{0.18\linewidth}p{0.24\linewidth}p{0.27\linewidth}@{}}
\toprule
 & \textbf{Normal} ($\theta_i\!=\!0$) & $\boldsymbol{\perp}$ \textbf{pol} & $\boldsymbol{\parallel}$ \textbf{pol}\\
\midrule
\rowcolor{rowB}$\Gamma$ \tiny refl.\ wave & $\tfrac{\eta_2-\eta_1}{\eta_2+\eta_1}$ & $\tfrac{\eta_2 c_i-\eta_1 c_t}{\eta_2 c_i+\eta_1 c_t}$ & $\tfrac{\eta_2 c_t-\eta_1 c_i}{\eta_2 c_t+\eta_1 c_i}$\\
$\tau$ \tiny trans.\ wave & $\tfrac{2\eta_2}{\eta_2+\eta_1}$ & $\tfrac{2\eta_2 c_i}{\eta_2 c_i+\eta_1 c_t}$ & $\tfrac{2\eta_2 c_i}{\eta_2 c_t+\eta_1 c_i}$\\
...
\rowcolor{rowB}$T$ \tiny trans.\ pwr & $|\tau|^2\tfrac{\eta_1}{\eta_2}$ & $|\tau_\perp|^2\tfrac{\eta_1 c_t}{\eta_2 c_i}$ & $|\tau_\parallel|^2\tfrac{\eta_1 c_t}{\eta_2 c_i}$\\
