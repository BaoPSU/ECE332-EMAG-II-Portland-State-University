...
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{0.5pt}\fontsize{4.6}{5.4}\selectfont\begin{tabular}{@{}p{0.18\linewidth}p{0.13\linewidth}p{0.32\linewidth}p{0.35\linewidth}@{}}
\toprule
 & \textbf{Normal} ($\theta_i\!=\!0$) & $\boldsymbol{\perp}$ \textbf{pol} & $\boldsymbol{\parallel}$ \textbf{pol}\\
\midrule
\rowcolor{rowB}$\Gamma$ \tiny refl.\ wave & $\tfrac{\eta_2-\eta_1}{\eta_2+\eta_1}$ & $\tfrac{\eta_2\cos\theta_i-\eta_1\cos\theta_t}{\eta_2\cos\theta_i+\eta_1\cos\theta_t}$ & $\tfrac{\eta_2\cos\theta_t-\eta_1\cos\theta_i}{\eta_2\cos\theta_t+\eta_1\cos\theta_i}$\\
$\tau$ \tiny trans.\ wave & $\tfrac{2\eta_2}{\eta_2+\eta_1}$ & $\tfrac{2\eta_2\cos\theta_i}{\eta_2\cos\theta_i+\eta_1\cos\theta_t}$ & $\tfrac{2\eta_2\cos\theta_i}{\eta_2\cos\theta_t+\eta_1\cos\theta_i}$\\
