...
\begin{ebox}
\textit{\color{coral}\textbf{Med.\ 1} ($z<0$) incident side; \textbf{Med.\ 2} ($z\ge0$) transmitted. Shorthand: $c_i\!=\!\cos\theta_i$, $c_t\!=\!\cos\theta_t$. \textbf{All $\Gamma,\tau,R,T$ are unitless} ($\eta$'s cancel; $R,T$ are power ratios).}\\[1pt]
