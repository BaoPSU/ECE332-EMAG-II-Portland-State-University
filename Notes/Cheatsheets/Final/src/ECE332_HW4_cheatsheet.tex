...
\eq{Power density formulas}{$l/\lambda<1/50$; far field}
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.35\linewidth}|p{0.59\linewidth}@{}}
\toprule
\rowcolor{rowB}Power density & $S(R,\theta) = S_{\max}\sin^2\theta\;(\text{W/m}^2)$\\
Max pwr density & $S_{\max} = \dfrac{\eta_0\,k^2 I_0^2\, l^2}{32\pi^2 R^2}\;(\text{W/m}^2)$\\
\bottomrule
\end{tabular}}}\par}
