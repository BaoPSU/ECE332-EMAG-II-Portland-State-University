...
\textit{\color{coral}Narrow-beam Gaussian shortcut ($\sin\theta\!\approx\!\theta$, extend to $\infty$):}
\[\color{coral}\Omega_p \approx \tfrac{\pi}{a} = \tfrac{\pi\,\theta_{1/2}^2}{\ln 2}\quad(F\!=\!e^{-a\theta^2})\]
\textit{\color{coral}Non-Gaussian: no closed form, use Wolfram / numerical.}\\[1pt]
