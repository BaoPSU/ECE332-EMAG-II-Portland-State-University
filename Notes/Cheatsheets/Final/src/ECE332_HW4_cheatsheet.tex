...
{\fontsize{5.4}{6}\selectfont
$S(R,\theta)$ avg.\ pwr dens.\ at $(R,\theta)$ (W/m$^2$).\quad $l$ antenna length (m, the rod itself).\quad $I_0$ peak current in dipole (A).\quad $R$ distance from antenna to obs.\ point (m).\quad $\theta$ angle from dipole axis (rad/$^\circ$).\quad $k\!=\!2\pi/\lambda$ wavenumber (rad/m).\quad $\eta_0\!=\!120\pi\!\approx\!377\,\Omega$ free-space impedance.\par}\\[1pt]
