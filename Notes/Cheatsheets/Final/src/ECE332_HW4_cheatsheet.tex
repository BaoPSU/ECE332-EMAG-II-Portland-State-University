...
\midrule
\rowcolor{rowB}Isotropic ($l$ N/A) & 1 & 0 & ---\\
Hertzian ($l\!<\!\lambda/50$) & 1.5 & 1.76 & $80\pi^2(l/\lambda)^2$\\
\rowcolor{rowB}Half-wave ($l\!=\!\lambda/2$) & 1.64 & 2.15 & $73.2$\\
$\lambda/4$ monopole ($l\!=\!\lambda/4$, gnd) & 1.64 & 2.15 & $36.6$\\
\rowcolor{rowB}Full-wave ($l\!=\!\lambda$) & 2.41 & 3.82 & 199\\
\bottomrule
\end{tabular}}}\par}
...
\begin{ebox}
\eq{Directivity from aperture area}{uniform illumination}
\[D \approx \tfrac{4\pi A_p}{\lambda^2}\;(\text{unitless})\quad\Rightarrow\;A_e\!\approx\!A_p\]
\eq{Directivity from beamwidths}{rectangular beam}
\[D \approx \tfrac{4\pi}{\beta_{xz}\beta_{yz}}\;\text{(use rad)}\]
\textit{Circular beam ($\beta_{xz}\!=\!\beta_{yz}\!=\!\beta$): $D\approx 4\pi/\beta^2$.}\\[1pt]
\eq{Half-power beamwidth}{uniform rect.\ illumination}
