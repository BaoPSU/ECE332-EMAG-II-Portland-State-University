...
\begin{ebox}
\eq{STEP 0}{$l$ = antenna rod length (m); $c\!=\!3\!\times\!10^8$ m/s}
...
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.30\linewidth}p{0.64\linewidth}@{}}
\toprule
\rowcolor{rowB}Power density (W/m$^2$) & $S(R,\theta) = S_{\max}\sin^2\theta$\\
Max pwr density (W/m$^2$) & $S_{\max} = \dfrac{\eta_0\,k^2 I_0^2\, l^2}{32\pi^2 R^2}$\\
\bottomrule
\end{tabular}}}\par}
...
$S_{\max}$: max pwr density (W/m$^2$) & \\
\bottomrule
\end{tabular}}}\par}
\eq{Max @ broadside}{$\perp$ to dipole axis = equator plane}\,$\theta_{\max}\!=\!\pi/2$\\
