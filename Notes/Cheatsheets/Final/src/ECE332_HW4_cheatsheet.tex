...
\eq{Physical cross section}{wire dipole, diameter $d$; $l$ from COMMON DIPOLE PARAMS}
\[A_p = l\,d\;\;\text{(any dipole)};\quad\text{e.g.\ half-wave: }(\lambda/2)d,\ \lambda/4: (\lambda/4)d\]
