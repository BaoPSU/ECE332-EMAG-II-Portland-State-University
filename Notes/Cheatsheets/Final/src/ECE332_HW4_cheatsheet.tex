...
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.22\linewidth}p{0.30\linewidth}p{0.38\linewidth}@{}}
\toprule
Threshold & $X\!=\!10^{\text{dB}/10}$ & Gauss.\ $\theta_X$\\
\midrule
\rowcolor{rowB}HPBW ($-3$\,dB) & $0.5$ & $\sqrt{\ln 2/a}$\\
$-6$ dB & $0.25$ & $\sqrt{\ln 4/a}$\\
\rowcolor{rowB}$-10$ dB & $0.1$ & $\sqrt{\ln 10/a}$\\
Null (FNBW) & $0$ & first zero of $F$\\
\bottomrule
\end{tabular}}}\par}
