...
\begin{ebox}
\textit{Works for any power-like quantity: $G$ gain, $D$ directivity, $P_r/P_t$, SNR, etc.}
\[X_{\text{dB}} = 10\log_{10}X_{\text{lin}}\qquad X_{\text{lin}} = 10^{X_{\text{dB}}/10}\]
\textit{e.g.\ $D_{\text{dB}}\!=\!10\log_{10}D$;\, $G_{\text{dB}}\!=\!10\log_{10}G$;\, SNR$_{\text{dB}}\!=\!10\log_{10}(P_r/P_N)$.}
