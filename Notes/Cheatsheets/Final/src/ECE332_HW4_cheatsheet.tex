...
\textit{\color{coral}For $\lambda/4$ or $\lambda/2$: plug $\pi l/\lambda$ from DIPOLE TYPE table into ARB formula. Symmetric dipoles: $\theta_{\max}\!=\!\pi/2$. $D, R_{\text{rad}}$ in COMMON DIPOLE PARAMS. $\lambda/4$ shortcut: $S_{\max}\!=\!(1\!-\!\sqrt{2}/2)^2 S_0\!\approx\!0.0858\,S_0$, $S_0\!=\!15I_0^2/\pi R^2$.}
\end{ebox}
...
\begin{ebox}
\textit{\color{coral}For Friis: $G_t\!=\!G_r\!=\!D$ below (default lossless $\xi\!=\!1$).}\\[1pt]
