...
\textit{\color{coral}Gaussian $F\!=\!e^{-a\theta^2}\!=\!X\ \Rightarrow\ \theta_X\!=\!\sqrt{-\ln X/a}$:}\\
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}ll@{}}
\toprule
Threshold & Gauss.\ $\theta_X$\\
\midrule
\rowcolor{rowB}HPBW ($-3$\,dB, $X\!=\!0.5$) & $\sqrt{\ln 2/a}$\\
$-6$ dB ($X\!=\!0.25$) & $\sqrt{\ln 4/a}$\\
\rowcolor{rowB}$-10$ dB ($X\!=\!0.1$) & $\sqrt{\ln 10/a}$\\
