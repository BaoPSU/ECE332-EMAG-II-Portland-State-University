...
\[S(R,\theta) = S_{\max}\sin^2\theta\;(\text{W/m}^2)\]
\[S_{\max} = \tfrac{\eta_0\,k^2 I_0^2\, l^2}{32\pi^2 R^2}\;(\text{W/m}^2)\]
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.10\linewidth}p{0.38\linewidth}p{0.10\linewidth}p{0.36\linewidth}@{}}
\toprule
