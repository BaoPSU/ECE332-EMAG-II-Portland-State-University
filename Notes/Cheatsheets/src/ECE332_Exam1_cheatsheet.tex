...
\begin{ebox}
{\centering\includegraphics[width=0.80\linewidth,keepaspectratio]{coaxial_fig.png}\par}
...
\begin{ebox}
{\centering\includegraphics[width=0.55\linewidth,keepaspectratio]{conductor_3d.png}\par}
