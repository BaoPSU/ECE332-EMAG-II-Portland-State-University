...
\[V(\mathbf{R},t)=\frac{1}{4\pi\varepsilon}\int_{V'}\frac{\rho_v\!\left(\mathbf{R}_i,\,t-R'/u_p\right)}{R'}\,dV'\]
\[A(\mathbf{R},t)=\frac{\mu}{4\pi}\int_{V'}\frac{\mathbf{J}\!\left(\mathbf{R}_i,\,t-R'/u_p\right)}{R'}\,dV'\]
\textit{$R'=|\mathbf{R}-\mathbf{R}_i|$;\enspace effects propagate at $u_p\approx c$}
\end{ebox}
