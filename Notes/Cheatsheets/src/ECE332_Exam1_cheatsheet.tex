...
\rowcolor{rowB}$\mathbf{E}(t)$ & $\operatorname{Re}\{\tilde{\mathbf{E}}\,e^{j\omega t}\}$ & $\operatorname{Re}\{\tilde{\mathbf{E}}\,e^{j\omega t}\}$\\
$\mathbf{H}(t)$ & $\operatorname{Re}\{\tilde{\mathbf{H}}\,e^{j\omega t}\}$ & $\operatorname{Re}\{\tilde{\mathbf{H}}\,e^{j\omega t}\}$\\
