...
\rowcolor{rowB}$\tilde{\mathbf{H}}$ from $\tilde{\mathbf{E}}$ & $\dfrac{\hat{k}\times\tilde{\mathbf{E}}}{\eta}$ & $\dfrac{\hat{k}\times\tilde{\mathbf{E}}}{\eta_c}$\\[4pt]
...
\bottomrule
\end{tabular}}}\par}
\textit{Time domain: $\mathbf{F}(t)=\operatorname{Re}\{\tilde{\mathbf{F}}\,e^{j\omega t}\}$ for both $\mathbf{E}$ and $\mathbf{H}$.}
\end{ebox}
