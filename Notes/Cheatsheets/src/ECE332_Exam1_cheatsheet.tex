...
$R'\!=\!|\mathbf{R}\!-\!\mathbf{R}_i|$ (m) dist.\ src$\to$obs;\enspace $t\!-\!R'/u_p$ retarded time;\enspace $u_p\!\approx\! c$\\
$\rho_v$: C/m$^3$;\enspace $\mathbf{J}$: A/m$^2$;\enspace $V$: scalar pot.\ (V);\enspace $\mathbf{A}$: vector mag.\ pot.\ (Wb/m)
\end{ebox}
