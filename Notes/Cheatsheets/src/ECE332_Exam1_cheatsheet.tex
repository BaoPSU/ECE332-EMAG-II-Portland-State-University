...
\rowcolor{rowB}$\mathbf{E}(z,t)$ & $E_0\cos(\omega t-kz+\phi)\,\hat{e}$ & n/a\\
$\mathbf{H}(z,t)$ & $\tfrac{E_0}{\eta}\cos(\omega t-kz+\phi)\,(\hat{k}\times\hat{e})$ & n/a\\
\rowcolor{rowB}$\mathbf{H}(t)$ direct & $\tfrac{1}{\eta}(\hat{k}\times\mathbf{E}(t))$ & n/a\\
$\mathbf{E}(t)$ direct & $-\eta(\hat{k}\times\mathbf{H}(t))$ & n/a\\
\bottomrule
\end{tabular}}}\par}
\end{ebox}
