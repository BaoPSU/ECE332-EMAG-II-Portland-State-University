...
\eq{Lossless base wave}{$\sigma=0\Rightarrow\alpha=0$, no decay}
\[\mathbf{E}(x,t)=E_0\cos(\omega t\pm kx+\phi_0)\,\hat{e}\quad\text{(V/m)}\]
...
\textit{\color{coral}$\sigma=0\Rightarrow$ lossless ($\alpha\!=\!0$, $\beta\!=\!k$).\enspace$\sigma>0\Rightarrow$ lossy ($\alpha>0$, wave decays).}
\end{ebox}

\vspace{0.3pt}
\shead{coralbg}{coral}{LOSSY WAVE --- GENERAL FORM}
\begin{ebox}
\eq{Lossy wave}{decays as $e^{-\alpha x}$;\enspace$\alpha>0$ (Np/m)}
\[\mathbf{E}(x,t)=E_0\,e^{-\alpha x}\cos(\omega t-\beta x+\phi_0)\,\hat{e}\quad\text{(V/m)}\]
\textit{$\beta$ = phase const (rad/m).\enspace Lossless: set $\alpha\!=\!0$, $\beta\!=\!k$, drop $e^{-\alpha x}$.}
\end{ebox}
...
\vspace{0.3pt}
\shead{graybg}{gray}{TRIG PHASE SHIFT IDENTITIES}
\begin{ebox}
{\centering\makebox[0.98\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.52\linewidth}p{0.43\linewidth}@{}}
\toprule
Input & Result\\
\midrule
\rowcolor{rowB}$\sin(\omega t\!-\!kz+\tfrac{\pi}{2})$ & $\phantom{-}\cos(\omega t\!-\!kz)$\\
$\sin(\omega t\!-\!kz-\tfrac{\pi}{2})$ & $-\cos(\omega t\!-\!kz)$\\
\rowcolor{rowB}$\sin(\omega t\!-\!kz+\pi)$ & $-\sin(\omega t\!-\!kz)$\\
$\sin(\omega t\!-\!kz-\pi)$ & $-\sin(\omega t\!-\!kz)$\\
\rowcolor{rowB}$\cos(\omega t\!-\!kz+\tfrac{\pi}{2})$ & $-\sin(\omega t\!-\!kz)$\\
$\cos(\omega t\!-\!kz-\tfrac{\pi}{2})$ & $\phantom{-}\sin(\omega t\!-\!kz)$\\
\rowcolor{rowB}$\cos(\omega t\!-\!kz+\pi)$ & $-\cos(\omega t\!-\!kz)$\\
$\cos(\omega t\!-\!kz-\pi)$ & $-\cos(\omega t\!-\!kz)$\\
\bottomrule
\end{tabular}}}\par}
\end{ebox}
