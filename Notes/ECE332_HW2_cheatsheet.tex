...
\begin{ebox}
{\centering\includegraphics[width=0.50\linewidth,keepaspectratio]{pol_ellipse}\par}\vspace{0.5pt}
...
\begin{ebox}
$a_x,a_y$ --- bounding box half-widths (V/m)\\
$\delta$ --- phase difference (rad)\\
$\psi_0=\arctan(a_y/a_x)$ --- auxiliary angle\\
$\gamma\in[0,\pi)$ --- rotation/tilt angle\\
$\chi\in[-\pi/4,\pi/4]$ --- ellipticity angle\\
$\chi>0$: RHEP (CCW);\;$\chi<0$: LHEP (CW)
\end{ebox}
\end{minipage}\hfill
\begin{minipage}[t]{0.19\linewidth}
