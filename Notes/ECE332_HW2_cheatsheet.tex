...
\vspace{1pt}
\shead{tealbg}{teal}{$\psi$ ORIENTATION \& POLARIZATION TYPE}
\begin{ebox}
...
\textit{$\psi$ = orientation angle — describes the direction the ellipse is tilted.}\\[1pt]
{\centering\begin{tabular}{@{}p{0.3\linewidth}p{0.62\linewidth}@{}}
\toprule
...
\textit{$\chi>0$: RH/CW.\enspace$\chi<0$: LH/CCW.\enspace$|\chi|=\pi/4$: circ.\enspace$\chi=0$: linear.}
\end{ebox}
