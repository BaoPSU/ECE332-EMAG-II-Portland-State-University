...
\vspace{0.3pt}
\shead{coralbg}{coral}{EXACT FORMULAS (ANY MEDIUM)}
\begin{ebox}
\eq{Let $X=\sqrt{1+(\sigma/\omega\varepsilon')^2}=\sqrt{1+(\varepsilon''/\varepsilon')^2}$,\;$\varepsilon''=\sigma/\omega$,\;$\varepsilon'=\varepsilon_r\varepsilon_0$}{}
...
\[\eta_c=\frac{\eta}{X^{1/2}}\angle\theta_\eta\;(\Omega),\quad\theta_\eta=\tfrac{1}{2}\arctan\!\tfrac{\sigma}{\omega\varepsilon'}\;\text{(rad)}\]
