...
{\centering\makebox[0.92\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.37\linewidth}p{0.52\linewidth}@{}}
\toprule
...
{\centering\makebox[0.92\linewidth][c]{{\setlength{\tabcolsep}{2pt}\begin{tabular}{@{}p{0.27\linewidth}p{0.32\linewidth}p{0.27\linewidth}@{}}
\toprule
